...
\end{equation}
where $R_0(z)$ is the maximal cylindrical radius of the shock front. In the case of young stars, however,  the circum-stellar disk constrains the stellar wind which cannot expand beyond the inner hole in the accretion disk. In our model we thus fix $\omega(z=0)$.
