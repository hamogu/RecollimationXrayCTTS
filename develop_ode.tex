...
The solution to the ODE determines the locations of the shock front. Thus allows us to calculate the pre-shock velocity perpendicular to the shock front using eqn.~\ref{eqn:v0} and the post-shock temperature $T$.