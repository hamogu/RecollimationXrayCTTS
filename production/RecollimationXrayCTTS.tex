...
\author{Hans Moritz G{\"{u}}nther\affil{Harvard-Smithsonian Center for Astrophysics} Christian\affil{Affiliation not available} Zhi-Yun Li\affil{Affiliation not available}}
...
\hline
\end{tabular}
\tablenotetext{a}{The errors represent statistical uncertainties from the $\chi^2$ fit. Systematic uncertainties are discussed in the text.}
\tablenotetext{b}{fixed during fit}
\end{table}
