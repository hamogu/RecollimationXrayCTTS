...
Initially, the stellar wind is relatively cold and thus the thermodynamic pressure can be neglected, so $P_0=0$. In the strong shock limit $v_0=4\;v_1$. With these two simplifications, eqn.~\ref{eqn:RH3} yields
\begin{equation} \label{eqn:4}
P_1 = \frac{3}{4} \rho_0 v_0^2
\end{equation}

In our case we are dealing with an oblique shock (Figure~\ref{fig:sketch}. Equations~\ref{RH1} to \ref{eqn:4} stay valid for oblique shocks if only the velocity component perpendicular to the shock front is taken as $v_0$ and $v_1$. 
