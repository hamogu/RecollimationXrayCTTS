...
\citet{2012MNRAS.422.2282K} to non-relativistic speeds and Figure~1 in their publication shows the geometry of this model in much detail} and we refer to their discussion and their figure~1 for a more detailed description. \textbf{Although the basic geometry is the same, we chose to include our Fig.~\ref{fig:sketch} in this work for the benefit of reader who are not familiar with the work of \citet{2012MNRAS.422.2282K} on extra-galactic jets.} 
